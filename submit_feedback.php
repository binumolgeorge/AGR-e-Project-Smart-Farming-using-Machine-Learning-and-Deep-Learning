...
// Retrieve farmer's name (assuming you have this in session or database)
$farmer_name = $_SESSION['name']; // Ensure 'name' is stored in session during login
...
// Prepare and bind
$stmt = $conn->prepare("INSERT INTO feedback (name, username, subject, message, farmer_id) VALUES (?, ?, ?, ?, ?)");
$stmt->bind_param("ssssi", $name, $username, $subject, $message, $farmer_id);
...
if ($stmt->execute()) {
        ...
        <body>
            ...
            <div class='message-container'>
                <h2>Thank you for your Feedback, $farmer_name</h2>
